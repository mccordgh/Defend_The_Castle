define(['Class'], function(Class){
	...
	let SoundManager = Class.extend({
		...
		setSounds: function(){
			...
			this.evilLaugh = sounds[`${CURRENT_PATH}/res/sound/evillaugh.ogg`];
			this.selectSound.volume = 0.7;
			this.startSound.volume = 0.7;
			this.explode.volume = 0.7;
			this.explodeBat.volume = 0.5;
			this.gameMusic.volume = 1;
			this.lvlup.volume = 1.2;
			// this.lvldown.volume = 0.8;
			this.spawn.volume = 0.7;
			this.monster.volume = 1.2;
			this.sword.volume = 1;
			this.explode.playbackRate = 1;
